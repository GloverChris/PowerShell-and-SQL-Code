# See README.MD for PARAM information
...
$scriptVersion = "2019-22-07"

# This script name, with various levels of details
$argv0 = Get-Item $MyInvocation.MyCommand.Definition
$script = "AirWatchMon"              # Ex: PSService
$scriptName = 'status checker.ps1'               # Ex: PSService.ps1
$scriptFullName = & 'C:\Users\glochri\Desktop\status checker.ps1'      # Ex: C:\Temp\PSService.ps1

# Global settings
$serviceName = $script                  # A one-word name used for net start commands
$serviceDisplayName = " AirWatch Monitor"
$ServiceDescription = "It sends metrics to cloudwatch about AirWatch "
